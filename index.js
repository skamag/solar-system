...
function initScene(data) {
  ...
  const jupiter = getPlanet({ size: 0.4, distance: 10, img: 'jupiter.png' });
  ...
  const saturn = getPlanet({ children: [saturnRing], size: 0.35, distance: 12, img: 'saturn.png' });
  ...
  const uranus = getPlanet({ children: [uranusRing], size: 0.3, distance: 14, img: 'uranus.png' });
  // const uranus = getPlanet({ children: [uranusRing], size: 0.3, distance: 3.75, img: 'uranus.png' });
  solarSystem.add(uranus);

  const neptune = getPlanet({ size: 0.3, distance: 16, img: 'neptune.png' });
